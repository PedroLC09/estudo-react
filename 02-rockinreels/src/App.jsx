...
function App() {
  ...
  return (
    <div className='cont-app'>
      <h1 id='tituloPrincipal'>Rock in Reels</h1>
      <div className="cap00 capitulos">
        ...
        <p>
          ...
          Mas, para tornar essa ideia realidade ele vai precisar convidar mais de seus amigos músicos para se apresentarem. Com as apresentações definidas ele poderá buscar patrocínios e depois encontrar comércios para atenderem (virtualmente) durante o evento.</p>
...
<button onClick={() => setCapitulo03(true)}>Mentir</button>
      ...
      <div className="cap05 capitulos">
        ...
        <p>
          Roque não entende a intenção de Yasmina,
          fica receoso e acaba rejeitando a proposta.
          Por conta desta decisão o Rock in Reels não viraliza.
          Acontece, duas boas bandas tocam, mas o evento nunca explode 
          para o sucesso que poderia ter sido.
     ...
     { capitulo07 &&
      <div className="cap07 capitulos">
        ...
        <p>
           Roque coloca o orgulho de lado e se dobra à proposta de seu pai,
     ...
     { capitulo09 &&
      <div className="cap09 capitulos">
        <h2>09: Rejeita HT</h2>
        <p>
           Roque resolve não arriscar e não inclui a Horrível Trio no evento.
     ...
     { capitulo10 && 
      <div className="cap10 capitulos">
        ...
        <p>
          O corte de duas das bandas originais do festival cria uma onda de revoltas entre os fãs e o festival sobre um enorme cancelamento.
